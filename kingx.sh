...
wget --quiet -O iplist.txt https://raw.githubusercontent.com/kingxvpn/AS/master/ip.txt
...
echo "<pre>SETUP BY KingX PM +601139121710</pre>" > /home/vps/public_html/index.php
